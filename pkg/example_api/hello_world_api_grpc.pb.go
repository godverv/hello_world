...
func (c *helloWorldAPIClient) Version(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
...
func (UnimplementedHelloWorldAPIServer) Version(context.Context, *PingRequest) (*PingResponse, error) {
...
func _HelloWorldAPI_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldAPIServer).Version(ctx, req.(*PingRequest))
	}
